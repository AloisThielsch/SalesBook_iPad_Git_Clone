...
@property (nonatomic)           id<PRKGeneratorDataSource> dataSource;
@property (nonatomic)           id<PRKGeneratorDelegate> delegate;
@property (nonatomic)           enum PRKPageSize;
@property (nonatomic)           NSOperationQueue * renderingQueue;
@property (nonatomic)           int totalItems;
@property (nonatomic)           int itemsFirstPage;
