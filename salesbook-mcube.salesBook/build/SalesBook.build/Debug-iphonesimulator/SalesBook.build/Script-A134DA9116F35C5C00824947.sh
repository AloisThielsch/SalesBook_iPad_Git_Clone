...
SHORT_VERSION=$(git --git-dir="${PROJECT_DIR}/.git" --work-tree="${PROJECT_DIR}" rev-parse --short HEAD)
...
#/usr/libexec/PlistBuddy -c "Set :FullVersion ${FULL_VERSION}" "${INFOPLIST_FILE}"
